...
const mutations = {
  ...
  setResultTableData: (
    state: DataCollectionStoreState,
    payload: TableDataWithTotal<Result>
  ) => {
...
const actions = {
  ...
  getResultData: async (
    { commit }: StoreActionContext<DataCollectionStoreState>,
